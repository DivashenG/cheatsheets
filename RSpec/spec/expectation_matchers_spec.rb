describe 'Expectation Matchers' do
  ...
  describe 'truthiness matchers' do
    ...
    it 'will match truthy/falsey' do
      expect(1 < 2).to be_truthy      # be_truthy was known as be_true
      expect(1 > 2).to be_falsey      # be_falsey was known as be_false
